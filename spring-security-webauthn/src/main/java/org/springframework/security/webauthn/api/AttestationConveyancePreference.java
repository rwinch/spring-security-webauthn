...
public final class AttestationConveyancePreference {
	...
	/**
	 * The <a href="https://www.w3.org/TR/webauthn-3/#dom-attestationconveyancepreference-none">none</a> preference
	 * indicates that the Relying Party is not interested in
	...
	/**
	 * The <a href="https://www.w3.org/TR/webauthn-3/#dom-attestationconveyancepreference-indirect">indirect</a> preference
	 * indicates that the Relying Party wants to receive a verifiable
	 * <a href="https://www.w3.org/TR/webauthn-3/#attestation-statement">attestation statement</a>, but allows the
	 * client to decide how to obtain such an attestation statement.
	 */
	public static final AttestationConveyancePreference INDIRECT = new AttestationConveyancePreference("indirect");

	/**
	 * The <a href="https://www.w3.org/TR/webauthn-3/#dom-attestationconveyancepreference-direct">direct</a> preference
	 * indicates that the Relying Party wants to receive the
	 * <a href="https://www.w3.org/TR/webauthn-3/#attestation-statement">attestation statement</a> as generated by the
	 * <a href="https://www.w3.org/TR/webauthn-3/#authenticator">authenticator</a>.
	 */
	public static final AttestationConveyancePreference DIRECT = new AttestationConveyancePreference("direct");

	/**
	 * The <a href="https://www.w3.org/TR/webauthn-3/#dom-attestationconveyancepreference-enterprise">enterprise</a>
	 * preference indicates that the Relying Party wants to receive an
	 * <a href="https://www.w3.org/TR/webauthn-3/#attestation-statement">attestation statement</a> that may include
	...
	public static AttestationConveyancePreference valueOf(String value) {
		switch (value) {
			...
			default: return new AttestationConveyancePreference(value);
		}
	}
